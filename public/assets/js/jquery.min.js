...
(function(e, t) {
  ...
  const W = /^a(?:rea|)$/i;
  const X = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i;
  ...
  v.fn.extend({
    ...
    closest(e, t) {
      ...
      let s = [];
      const o =
        st.test(e) || typeof e !== "string" ? v(e, t || this.context) : 0;
      for (; r < i; r++) {
        n = this[r];
  ...
  var sn = /\[\]$/;
  const on = /\r?\n/g;
  const un = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i;
