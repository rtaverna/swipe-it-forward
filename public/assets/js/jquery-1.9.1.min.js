...
*/ (function(
  ...
  const H = function(e) {
    (o.addEventListener || e.type === "load" || o.readyState === "complete") &&
      (q(), b.ready());
  };
  var q = function() {
    o.addEventListener
  ...
  (b.fn = b.prototype = {
    ...
    map(e) {
      return this.pushStack(b.map(this, (t, n) => e.call(t, n, t)));
    },
    end() {
    ...
    (b.extend = b.fn.extend = function() {
      ...
      let c = !1;
      for (
        typeof s === "boolean" && ((c = s), (s = arguments[1] || {}), (u = 2)),
          typeof s === "object" || b.isFunction(s) || (s = {}),
          l === u && ((s = this), --u);
        l > u;
        u++
      ) {
  ...
  (b.Callbacks = function(e) {
    ...
    b.extend({
      ...
      when(e) {
        let t = 0;
        const n = h.call(arguments);
        const r = n.length;
        let i = r !== 1 || (e && b.isFunction(e.promise)) ? r : 0;
        const o = i === 1 ? e : b.Deferred();
    ...
    (b.support = (function() {
      ...
      return (
        ...
        b(() => {
          ...
          const u = o.getElementsByTagName("body")[0];
          u &&
    ...
    if (b.acceptData(e)) {
      ...
      if ((f && p[f] && (i || p[f].data)) || !u || r !== t) {
        return (
          ...
          u ? ((a = o[n]), a == null && (a = o[b.camelCase(n)])) : (a = o),
          a
        );
      }
    }
  ...
  function R(e, t, n) {
    if (b.acceptData(e)) {
      ...
      const a = e.nodeType;
      const s = a ? b.cache : e;
      const u = a ? e[b.expando] : b.expando;
      if (s[u]) {
  ...
  function $(e) {
    let t;
    for (t in e)
      if ((t !== "data" || !b.isEmptyObject(e[t])) && t !== "toJSON") return !1;
    return !0;
  }
  b.extend({
    queue(e, n, r) {
  ...
  const X = /[\t\r\n]/g;
  const U = /\r/g;
  const V = /^(?:input|select|textarea|button|object)$/i;
  const Y = /^(?:a|area)$/i;
  const J = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i;
  const G = /^(?:checked|selected)$/i;
  const Q = b.support.getSetAttribute;
  const K = b.support.input;
  b.fn.extend({
    attr(e, t) {
    ...
    toggleClass(e, t) {
      ...
      return b.isFunction(e)
        ...
        : this.each(function() {
            ...
            } else (n === i || n === "boolean") && (this.className && b._data(this, "__className__", this.className), (this.className = this.className || e === !1 ? "" : b._data(this, "__className__") || ""));
          });
    },
    hasClass(e) {
      const t = ` ${e} `;
        ...
        if (o) {
          return (
            ...
            r && "get" in r && (n = r.get(o, "value")) !== t
              ? n
              : ((n = o.value),
                typeof n === "string" ? n.replace(U, "") : n == null ? "" : n)
          );
        }
      }
    }
        ...
        if (e && s !== 3 && s !== 8 && s !== 2) {
          return (
            ...
            r !== t
              ...
              : o && "get" in o && (i = o.get(e, n)) !== null ? i : e[n]
          );
        }
      },
      propHooks: {
    ...
    (z = {
      get(e, n) {
        const r = b.prop(e, n);
        const i = typeof r === "boolean" && e.getAttribute(n);
        const o =
          typeof r === "boolean"
            ? K && Q
              ? i != null
    ...
    b.support.hrefNormalized ||
      (b.each(["href", "src", "width", "height"], (e, n) => {
        b.attrHooks[n] = b.extend(b.attrHooks[n], {
          get(e) {
  ...
  (b.event = {
    ...
    trigger(n, r, i, a) {
      ...
      let d;
      const h = [i || o];
      let g = y.call(n, "type") ? n.type : n;
      let m = y.call(n, "namespace") ? n.namespace.split(".") : [];
      if (
        ((l = f = i = i || o),
        i.nodeType !== 3 &&
          i.nodeType !== 8 &&
    ...
    dispatch(e) {
      ...
      let a;
      let s = [];
      const u = h.call(arguments);
      const l = (b._data(this, "events") || {})[e.type] || [];
      const c = b.event.special[e.type] || {};
      if (
        ((u[0] = e),
          ...
          return b.nodeName(this, "form")
            ...
            : (b.event.add(this, "click._submit keypress._submit", e => {
                ...
                r &&
                  ...
                  (b.event.add(r, "submit._submit", e => {
                    e._submit_bubble = !0;
                  }),
    ...
    b.support.focusinBubbles ||
      b.each({ focus: "focusin", blur: "focusout" }, (e, t) => {
        let n = 0;
        const r = function(e) {
    ...
    (function(e, t) {
      ...
      const _ = "[\\x20\\t\\r\\n\\f]";
      const F = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+";
      const O = F.replace("w", "w#");
      const B = "([*^$|!~]?=)";
      const P = `\\[${_}*(${F})${_}*(?:${B}${_}*(?:(['"])((?:\\\\.|[^\\\\])*?)\\3|(${O})|)|)${_}*\\]`;
      const R = `:(${F})(?:\\(((['"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|${P.replace(
        3,
        8
      )})*)|.*)\\)|)`;
      const W = RegExp(`^${_}+|((?:^|[^\\\\])(?:\\\\.)*)${_}+$`, "g");
      const $ = RegExp(`^${_}*,${_}*`);
      const I = RegExp(`^${_}*([\\x20\\t\\r\\n\\f>+~])${_}*`);
      const z = RegExp(R);
      const X = RegExp(`^${O}$`);
      const U = {
        ID: RegExp(`^#(${F})`),
      ...
      const V = /[\x20\t\r\n\f]*[+~]/;
      const Y = /^[^{]+\{\s*\[native code/;
      const J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/;
      const G = /^(?:input|select|textarea|button)$/i;
      const Q = /^h\d$/i;
      const K = /'|\\/g;
      const Z = /\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g;
      const et = /\\([\da-fA-F]{1,6}[\x20\t\r\n\f]?|.)/g;
                ...
                ? function(e, t) {
                    ...
                    return e === t
                      ...
                      : (r =
                        ...
                        ? 1 & r ||
                          (e.parentNode && e.parentNode.nodeType === 11)
      ...
      function ut(e, t) {
        let n = t && e;
        const r = n && (~t.sourceIndex || j) - (~e.sourceIndex || j);
        if (r) return r;
      ...
      function yt(e, t, n, r, i, o) {
        return (
          ...
          ot((o, a, s, u) => {
            ...
            const d = [];
            const h = a.length;
            const g = o || xt(t || "*", s.nodeType ? [s] : s, []);
            const m = !e || (!o && t) ? g : mt(g, f, e, s, u);
      ...
      function vt(e) {
        ...
        let r;
        const o = e.length;
        const a = i.relative[e[0].type];
        const s = a || i.relative[" "];
        let u = a ? 1 : 0;
        const c = ht(e => e === t, s, !0);
        const p = ht(e => M.call(t, e) > -1, s, !0);
        let f = [
          function(e, n, r) {
            return (
              (!a && (r || n !== l)) ||
      ...
      function bt(e, t) {
        ...
        const s = function(s, u, c, f, d) {
          ...
          const w = d != null;
          const T = l;
          const C = s || (a && i.find.TAG("*", (d && u.parentNode) || u));
          const k = (N += T == null ? 1 : Math.random() || 0.1);
  ...
  const at = /Until$/;
  const st = /^(?:parents|prev(?:Until|All))/;
  const ut = /^.[^:#\[\.,]*$/;
  const lt = b.expr.match.needsContext;
  const ct = {
    children: !0,
    contents: !0,
    next: !0,
  ...
  b.fn.extend({
    ...
    closest(e, t) {
      ...
      const o = [];
      const a =
        lt.test(e) || typeof e !== "string" ? b(e, t || this.context) : 0;
      for (; i > r; r++) {
        n = this[r];
  ...
  function ft(e, t, n) {
    ...
    if (t.nodeType) {
      return b.grep(e, e => (e === t) === n);
    }
    if (typeof t === "string") {
      const r = b.grep(e, e => e.nodeType === 1);
      if (ut.test(t)) return b.filter(t, r, !n);
      t = b.filter(t, r);
    }
    return b.grep(e, e => b.inArray(e, t) >= 0 === n);
  }
  function dt(e) {
    const t = ht.split("|");
  ...
  const Nt = /^(?:checkbox|radio)$/i;
  const Ct = /checked\s*(?:[^=]|=\s*.checked.)/i;
  ...
  const jt = dt(o);
  const Dt = jt.appendChild(o.createElement("div"));
  (At.optgroup = At.option),
    ...
    b.fn.extend({
      ...
      wrapAll(e) {
        ...
        if (this[0]) {
          const t = b(e, this[0].ownerDocument)
            .eq(0)
            .clone(!0);
      ...
      remove(e, t) {
        ...
        for (; (n = this[r]) != null; r++) {
          (!e || b.filter(e, [n]).length > 0) &&
            (t || n.nodeType !== 1 || b.cleanData(Ot(n)),
            n.parentNode &&
      ...
      empty() {
        ...
        let t = 0;
        for (; (e = this[t]) != null; t++) {
          e.nodeType === 1 && b.cleanData(Ot(e, !1));
      ...
      domManip(e, n, r) {
        ...
        const h = p - 1;
        const g = e[0];
        const m = b.isFunction(g);
        if (
          m ||
          (!(p <= 1 || typeof g !== "string" || b.support.checkClone) &&
            Ct.test(g))
        ) {
  ...
  b.extend({
    clone(e, t, n) {
      ...
      let a;
      let s;
      const u = b.contains(e.ownerDocument, e);
      if (
    ...
    buildFragment(e, t, n, r) {
      ...
      for (; p > h; h++) {
        if (((o = e[h]), o || o === 0)) {
          if (b.type(o) === "object") b.merge(d, o.nodeType ? [o] : o);
          else if (wt.test(o)) {
    ...
    cleanData(e, t) {
      ...
      const u = b.expando;
      const l = b.cache;
      const p = b.support.deleteExpando;
      const f = b.event.special;
      for (; (n = e[s]) != null; s++) {
    ...
    e.getComputedStyle
      ? ((Rt = function(t) {
        ...
        (Wt = function(e, n, r) {
          ...
          let a;
          const s = r || Rt(e);
          let u = s ? s.getPropertyValue(n) || s[n] : t;
          const l = e.style;
          return (
            s &&
              (u !== "" ||
  ...
  function an(e, t, n, r, i) {
    ...
    let a = 0;
    for (; o < 4; o += 2) {
      n === "margin" && (a += b.css(e, n + Zt[o], !0, i)),
        r
          ? (n === "content" && (a -= b.css(e, `padding${Zt[o]}`, !0, i)),
            n !== "margin" && (a -= b.css(e, `border${Zt[o]}Width`, !0, i)))
          : ((a += b.css(e, `padding${Zt[o]}`, !0, i)),
            n !== "padding" && (a += b.css(e, `border${Zt[o]}Width`, !0, i)));
    }
    return a;
  }
  function sn(e, t, n) {
    ...
    const o = Rt(e);
    const a =
      b.support.boxSizing && b.css(e, "boxSizing", !1, o) === "border-box";
    if (i <= 0 || i == null) {
      if (
        ((i = Wt(e, t, o)),
        ...
        return on(
          ...
          r
            ? an(
                ...
                r,
                b.support.boxSizing &&
                  b.css(e, "boxSizing", !1, i) === "border-box",
                i
              )
            : 0
        );
    ...
    b.support.opacity ||
      (b.cssHooks.opacity = {
        ...
        set(e, t) {
          ...
          const i = b.isNumeric(t) ? `alpha(opacity=${100 * t})` : "";
      ...
      return this.map(function() {
        ...
        .map(function(e, t) {
          ...
          return n == null
            ? null
            : b.isArray(n)
              ? b.map(n, e => ({ name: t.name, value: e.replace(fn, "\r\n") }))
  ...
  function gn(e, t, n, r) {
    ...
    } else if (n || b.type(t) !== "object") r(e, t);
  ...
  const wn = /([?&])_=[^&]*/;
  const Tn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm;
  const Nn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/;
  const Cn = /^(?:GET|HEAD)$/;
  const kn = /^\/\//;
  const En = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/;
  const Sn = b.fn.load;
  ...
  function Mn(e, n) {
    let r;
    let i;
    const o = b.ajaxSettings.flatOptions || {};
  ...
  (b.fn.load = function(e, n, r) {
    ...
    b.extend({
      ...
      ajax(e, n) {
        ...
        let l;
        let c;
        const p = b.ajaxSetup({}, n);
        const f = p.context || p;
        const d = p.context && (f.nodeType || f.jquery) ? b(f) : b.event;
        const h = b.Deferred();
        const g = b.Callbacks("once memory");
        let m = p.statusCode || {};
        const y = {};
        const v = {};
        let x = 0;
        ...
        if (
          ...
          return N;
        (u = p.global),
          u && b.active++ === 0 && b.event.trigger("ajaxStart"),
  ...
  b.ajaxSetup({
    ...
    b.ajaxTransport("script", e => {
      if (e.crossDomain) {
        let n;
        const r = o.head || b("head")[0] || o.documentElement;
        return {
          send(t, i) {
  ...
  function er(e, t, n) {
    ...
    var u = function() {
      ...
      return (
        s.notifyWith(e, [l, o, n]), o < 1 && u ? n : (s.resolveWith(e, [l]), !1)
      );
    };
    var l = s.promise({
      elem: e,
  ...
  function nr(e, t, n) {
    ...
    n.queue ||
      ...
      e.nodeType === 1 &&
        ...
        b.css(e, "display") === "inline" &&
          b.css(e, "float") === "none" &&
          (b.support.inlineBlockNeedsLayout && un(e.nodeName) !== "inline"
            ? (d.zoom = 1)
    ...
    for (i in t) {
      if (((a = t[i]), Vn.exec(a))) {
        if (
          (delete t[i], (u = u || a === "toggle"), a === (m ? "hide" : "show"))
        )
          continue;
        g.push(i);
      }
      ...
      _default: {
        get(e) {
          ...
          return e.elem[e.prop] == null ||
            ...
            ? ((t = b.css(e.elem, e.prop, "")), t && t !== "auto" ? t : 0)
            : e.elem[e.prop];
        },
        set(e) {
          b.fx.step[e.prop]
  ...
  b.each(
    ...
    b.expr &&
      ...
      (b.expr.filters.animated = function(e) {
        return b.grep(b.timers, t => e === t.elem).length;
      }),
    ...
    (b.offset = {
      setOffset(e, t, n) {
        ...
        u
          ...
          t.top != null && (l.top = t.top - o.top + p),
          t.left != null && (l.left = t.left - o.left + f),
